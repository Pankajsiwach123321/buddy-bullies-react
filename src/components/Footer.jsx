    ...
    <div>
      <footer className="bg-footer m--1 bg-color-primary " id="join">
        <div className="container pb-5">
          ...
          <Row className=" pt-156">
            <Col lg={9}>
              <p className="fs-3xl fw-md font-family color-seacandary">LOGO</p>
              <p className="fs-sm fw-sm font-family color-tertiary w-388">
              ...
              <a
                href="mailto:pankusiwach000@gmail.com"
                target="_blank"
                className="fs-sm fw-sm font-family color-seacandary text-decoration-none"
              >
                Email@gmail.com
              </a>
            </Col>
              ...
              <Row>
                <Col className="pt-5 pt-lg-0 ">
                  <ul className="px-0 mb-0">
                    <li className="fs-sm fw-md font-family color-seacandary">
                      Resources
                    </li>
                    <li className="pt-2">
                      <a
                ...
                <Col className="pt-5 pt-lg-0   ">
                  <p className="fs-sm fw-md font-family color-seacandary mb-0">
                    Community
                  </p>
                  <div className="d-flex gap-4 pt-3">
                    ...
                    <a
                      href="https://discord.com/channels/@me/1124575418108870759"
                      target="_blank"
                    >
                      <svg
                        width="18"
